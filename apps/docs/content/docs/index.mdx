...
5. Create an API client for the storefront using the Scopes from the `Frontend B2B` template, and add the **Manage Custom objects** and **Manage Types** scopes (in addition to every scope that template already includes).
...
Open `https://web.next-hydra.localhost` to verify the storefront boots with your configured providers.
...
<Cards>
  ...
  />
  <Card title="Read platform updates" href="/docs/updates" />
