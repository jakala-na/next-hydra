/* oxlint-disable promise/prefer-await-to-callbacks -- Effect combinators transform Effect values. */
import type {
...
export const terminateAuthSessionReadFailure = Effect.fn(
  "AdminCurrentAuth.terminateSessionReadFailure"
