...
declare module 'gql.tada' {
 interface setupCache {
    ...
    "\n    query DrupalLandingPage($path: String!, $revision: ID) {\n      route(path: $path, revision: $revision) {\n        __typename\n        ... on RouteInternal {\n          entity {\n            __typename\n            ... on NodeLandingPage {\n              id\n              title\n              displayTitle\n              hideDisplayTitle\n              components {\n                __typename\n                ... on ParagraphInterface {\n                  id\n                }\n                ...DrupalHeroSection\n                ...DrupalDynamicProductCollection\n              }\n            }\n          }\n        }\n      }\n    }\n  ":
      TadaDocumentNode<{ route: { __typename: "RouteInternal"; entity: { __typename: "NodeLandingPage"; id: string; title: string; displayTitle: string | null; hideDisplayTitle: boolean | null; components: ({ __typename: "ParagraphDynamicProductCollection"; id: string; [$tada.fragmentRefs]: { DrupalDynamicProductCollection: "ParagraphDynamicProductCollection"; }; } | { __typename: "ParagraphHero"; id: string; [$tada.fragmentRefs]: { DrupalHeroSection: "ParagraphHero"; }; })[] | null; } | null; } | { __typename: "RouteExternal"; } | null; }, { revision?: string | null | undefined; path: string; }, void>;
  }
}
