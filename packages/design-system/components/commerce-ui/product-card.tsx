...
import PriceFormat from '@repo/design-system/components/commerce-ui/price-format-basic';
import StarRating_Fractions from '@repo/design-system/components/commerce-ui/star-rating-fractions';
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-teal-50 to-cyan-50 p-5 dark:from-teal-950/30 dark:to-cyan-950/30">
        {discount && (
          <div className="absolute top-3 left-3 z-10">
            <span className="relative inline-block rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 px-3 py-1.5 font-bold text-white text-xs">
              {discount}
            </span>
          </div>
        )}
