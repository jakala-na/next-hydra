      ...
      {isSale ? (
        <>
          ...
          <NumericFormat
            ...
            prefix={prefix}
            displayType="text"
            className={cn('font-medium text-[length:inherit]', classNameSalePrice)}
          />
          {showSavePercentage && (
            <span className={cn('rounded-sm bg-green-500/50 p-1 font-medium text-sm', classNameSalePercentage)}>
