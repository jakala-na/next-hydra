...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "data-[state=open]:text-accent-foreground'size-'])]:size-4 flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden [&_svg:not([class*= focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
