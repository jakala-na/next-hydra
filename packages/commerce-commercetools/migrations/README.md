...
A migration that adds a field must check `fieldExists()` first. This makes the operation retryable if the Type was created but migration tracking was not recorded.
