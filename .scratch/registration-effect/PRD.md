...
Create a new parallel model in the existing `registration-effect` package. The package will define Effect Schema domain classes and discriminated unions for registrations, invitations, actors, identities, roles, approval decisions, and commerce account outcomes.
...
- Build the POC in the existing parallel `registration-effect` package.
