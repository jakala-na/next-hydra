# Clarify Registration provider map composition
...
Align Registration runtime and documentation with the ADR: applications and provider modules choose concrete capability implementations, while Registration use-case programs depend only on provider-independent capabilities.
...
- [ ] Registration runtime/layer composition clearly chooses concrete implementations for provider-independent capability services.
